...
export type MoltenColorMode = 'molten' | 'ember' | 'frost';
...
const colorModeToFloat = (mode: MoltenColorMode) =>
...
export function MoltenMetal({
  ...
  useEffect(() => {
    ...
    // Listen on window so overlays (copy, CTAs) do not block interaction
