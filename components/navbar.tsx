...
export function Navbar() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 px-3 pt-3 sm:px-5 sm:pt-4">
      <div
        className={cn(
          "mx-auto flex h-14 max-w-6xl items-center gap-2 rounded-md border px-2 pl-2.5 pr-2 transition-all duration-300 sm:gap-3 sm:pl-3 sm:pr-2.5",
          scrolled
      ...
      >
        <Link
          href="/"
          className="group flex h-10 shrink-0 items-center gap-2.5 rounded-md px-1.5 transition-opacity hover:opacity-90"
              ...
              return (
                <li key={item.name}>
                  <Link
                    href={item.href}
                    className={cn(
                      "inline-flex h-8 items-center rounded-md px-2.5 text-[12px] font-medium transition-all duration-200 xl:px-3.5 xl:text-[13px]",
                      active
        ...
        <div className="ml-auto flex h-10 items-center gap-1.5">
          <AnimatedThemeToggler className="inline-flex h-10 w-10 items-center justify-center rounded-md text-foreground transition-colors hover:bg-foreground/8" />
          <GsapButton
            variant="brand"
            size="sm"
          ...
          <button
            ...
            onClick={() => setOpen((v) => !v)}
            className="inline-flex h-10 w-10 items-center justify-center rounded-md text-foreground transition-colors hover:bg-foreground/8 lg:hidden"
          >
      ...
      {open ? (
        <div className="mx-auto mt-2 max-w-6xl overflow-hidden rounded-md border border-border/60 bg-background/95 p-2 shadow-xl backdrop-blur-xl lg:hidden">
              ...
              return (
                <li key={item.name}>
                  <Link
                    href={item.href}
                    className={cn(
                      "block w-full rounded-md px-4 py-3 text-left text-sm",
                      active
